...
Source0  : https://files.pythonhosted.org/packages/dd/3b/18698bedf57c8cd1d752f63555e654575f06c1b1343fb8a484bdfb6e4fa7/b4-0.13.0.tar.gz
...
%prep
%setup -q -n b4-0.13.0
cd %{_builddir}/b4-0.13.0
pushd ..
cp -a b4-0.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708034101
